...
## 软件源手动配置指南
如果您处于无脚本执行权限的特殊环境，或希望手动掌控配置过程，请参考以下针对各发行版的详细命令。


## 1. Debian 11+ / Ubuntu 22.04+ 及更新版本
...
## 旧版本 Debian / Ubuntu 系统 (Debian 10 及以下)
...
```bash
sudo dnf install vantage -y
# 若系统为 CentOS 7，请使用：sudo yum install vantage -y
```
